...
<asp:Content ID="addproductbody" ContentPlaceHolderID="AdminPanelMaster" runat="Server">
    ...
    <br />
    <br />--%>
    <asp:Label ID="lbl_sku" runat="server" Text="SKU : " AssociatedControlID="txtSku"></asp:Label>
    <asp:TextBox ID="txtSku" runat="server" MaxLength="50"></asp:TextBox>
    <asp:RequiredFieldValidator ID="rfvSku" runat="server" ControlToValidate="txtSku"
        Display="Dynamic">(Required)</asp:RequiredFieldValidator>
    <br />
    <br />
    <asp:Label ID="lbl_pro_name" runat="server" Text="Product Title :" AssociatedControlID="txtPro_Title"></asp:Label>
    &nbsp;&nbsp;<asp:TextBox ID="txtPro_Title" runat="server" MaxLength="50"></asp:TextBox>
    <asp:RequiredFieldValidator ID="rfvPro_title" runat="server" ControlToValidate="txtPro_Title"
        Display="Dynamic">(Required)</asp:RequiredFieldValidator>
    <br />
    <br />
    <asp:Label ID="lblWeight" runat="server" Text="Weight : " AssociatedControlID="txtWeight"></asp:Label>
    &nbsp;&nbsp;<asp:TextBox ID="txtWeight" runat="server"></asp:TextBox>
    <asp:CompareValidator ID="cvWeight" runat="server" ControlToValidate="txtWeight"
        Operator="DataTypeCheck" Type="Double"> (Invalid Weight)</asp:CompareValidator>
    <br />
    <br />
    <asp:Label ID="lblMetaKeywords" runat="server" Text="Meta Keywords(optional) : "
        AssociatedControlID="txtMetaKeywords"></asp:Label>
    <br />
    ...
    <br />
    <br />
    <asp:Label ID="lbl_brand" runat="server" Text="Brand :" AssociatedControlID="txtBrand"></asp:Label>
    ...
    <br />
    <br />
    <asp:Label ID="lbl_colour" runat="server" Text="Colour :" AssociatedControlID="txtColour"></asp:Label>
    &nbsp;&nbsp;<asp:TextBox ID="txtColour" runat="server" MaxLength="20"></asp:TextBox>
    <br />
    <br />
    <asp:Label ID="lbl_featr" runat="server" Text="Features :" AssociatedControlID="ckeditorFeatures"></asp:Label>
    <br />
    <CKEditor:CKEditorControl ID="ckeditorFeatures" runat="server" Width="600px"></CKEditor:CKEditorControl>
    <asp:RequiredFieldValidator ID="rfvCKFeatures" runat="server" ControlToValidate="ckeditorFeatures"
        Display="Dynamic">(Required)</asp:RequiredFieldValidator>
    <br />
    <br />
    <asp:Label ID="lbl_descp" runat="server" Text="Description :" AssociatedControlID="ckeditorDescription"></asp:Label>
    <CKEditor:CKEditorControl ID="ckeditorDescription" runat="server" Width="600px"></CKEditor:CKEditorControl>
    <asp:RequiredFieldValidator ID="rfvCKDesc" runat="server" ControlToValidate="ckeditorDescription"
        Display="Dynamic">(Required)</asp:RequiredFieldValidator>
    <br />
    <br />
    <asp:Label ID="lbl_price" runat="server" Text="Price :" AssociatedControlID="txtPrice"></asp:Label>
    &nbsp;&nbsp;<asp:TextBox ID="txtPrice" runat="server"></asp:TextBox>
    <asp:RequiredFieldValidator ID="rfvPrice" runat="server" ControlToValidate="txtPrice"
        Display="Dynamic">(Required)</asp:RequiredFieldValidator>
    <asp:CompareValidator ID="cvPrice" runat="server" ControlToValidate="txtPrice" Operator="DataTypeCheck"
        Type="Currency">(Invalid price)</asp:CompareValidator>
    <br />
    <br />
    <asp:Label ID="lbl_mrktprc" runat="server" Text="Market Price :" AssociatedControlID="txtMrkt_price"></asp:Label>
    &nbsp;&nbsp;<asp:TextBox ID="txtMrkt_price" runat="server"></asp:TextBox>
    <asp:CompareValidator ID="cvMrktPrice" runat="server" ControlToCompare="txtPrice"
        ControlToValidate="txtMrkt_price" Display="Dynamic" ErrorMessage="(The Market price can not be small than Price)"
        Operator="GreaterThanEqual" Type="Currency"></asp:CompareValidator>
    <br />
    <br />
    <asp:Label ID="lbl_Qty" runat="server" Text="Quantity :" AssociatedControlID="txtQty"></asp:Label>
    &nbsp;&nbsp;<asp:TextBox ID="txtQty" runat="server"></asp:TextBox>
    <asp:RequiredFieldValidator ID="rfvQty" runat="server" ControlToValidate="txtQty"
        Display="Dynamic">(Required)</asp:RequiredFieldValidator>
    <asp:CompareValidator ID="cvQty" runat="server" ControlToValidate="txtQty" Operator="DataTypeCheck"
        Type="Integer">(Invalid Quantity)</asp:CompareValidator>
    <br />
    <br />
    ...
    <asp:RequiredFieldValidator ID="rfvDelivrd_Days" runat="server" ControlToValidate="txtDelivrd_Days"
        Display="Dynamic">(Required)</asp:RequiredFieldValidator>
    <asp:CompareValidator ID="cvDelivrdDays" runat="server" ControlToValidate="txtDelivrd_Days"
        Operator="DataTypeCheck" Type="Integer">(Invalid Delivered Days)</asp:CompareValidator>
    <br />
    <br />
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="fupl_img1"
        Display="Dynamic">(Required)</asp:RequiredFieldValidator>
    <br />
    <br />
