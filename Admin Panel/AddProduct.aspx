<%@ Page Title=""
  ...
  CodeFile="AddProduct.aspx.cs"
  Inherits="Admin_Panel_AddProduct" %>
...
<asp:Content ID="addproductbody"
  ...
  <asp:RequiredFieldValidator
    ID="rfvPro_title"
    runat="server"
    ControlToValidate="txtPro_Title"
    Display="Dynamic">(Required)</asp:RequiredFieldValidator>
  <br />
  <br />
  ...
  <asp:CompareValidator
    ...
    Type="Double"> (Invalid Weight)</asp:CompareValidator>
  <br />
  <br />
  <asp:Label ID="lblMetaKeywords"
    runat="server"
    Text="Meta Keywords(optional) : "
    AssociatedControlID="txtMetaKeywords"></asp:Label>
  <br />
  <asp:TextBox ID="txtMetaKeywords"
    runat="server"
    MaxLength="298"
    Columns="40" Rows="5"
    TextMode="MultiLine"></asp:TextBox>
  <br />
  <br />
  <asp:Label ID="lblMetaDescription"
    runat="server"
    Text="Meta Description : "
    AssociatedControlID="txtMetaDescription"></asp:Label>
  <br />
  <asp:TextBox ID="txtMetaDescription"
    runat="server"
    MaxLength="298"
    Columns="40" Rows="4"
    TextMode="MultiLine"></asp:TextBox>
  ...
  <CKEditor:CKEditorControl
    ID="ckeditorFeatures"
    runat="server"
    Width="600px"></CKEditor:CKEditorControl>
  <asp:RequiredFieldValidator
    ID="rfvCKFeatures"
    runat="server"
    ControlToValidate="ckeditorFeatures"
    Display="Dynamic">(Required)</asp:RequiredFieldValidator>
  <br />
  <br />
  <asp:Label ID="lbl_descp"
    runat="server"
    Text="Description :"
    AssociatedControlID="ckeditorDescription"></asp:Label>
  <CKEditor:CKEditorControl
    ID="ckeditorDescription"
    runat="server"
    Width="600px"></CKEditor:CKEditorControl>
  <asp:RequiredFieldValidator
    ID="rfvCKDesc"
    runat="server"
    ControlToValidate="ckeditorDescription"
    Display="Dynamic">(Required)</asp:RequiredFieldValidator>
  <br />
  <br />
  <asp:Label ID="lbl_price"
    runat="server"
    Text="Price :"
  ...
  <asp:CompareValidator
    ...
    ControlToValidate="txtMrkt_price"
    Display="Dynamic"
  ...
  <asp:RequiredFieldValidator
    ID="rfvQty" runat="server"
    ControlToValidate="txtQty"
    Display="Dynamic">(Required)</asp:RequiredFieldValidator>
  <asp:CompareValidator
    ID="cvQty" runat="server"
    ControlToValidate="txtQty"
    Operator="DataTypeCheck"
    Type="Integer">(Invalid Quantity)</asp:CompareValidator>
  <br />
  <br />
  <asp:Label ID="lbl_dlvrddays"
    runat="server"
  ...
  <asp:RequiredFieldValidator
    ID="rfvDelivrd_Days"
    runat="server"
    ControlToValidate="txtDelivrd_Days"
    Display="Dynamic">(Required)</asp:RequiredFieldValidator>
  <asp:CompareValidator
    ID="cvDelivrdDays"
    runat="server"
    ControlToValidate="txtDelivrd_Days"
    Operator="DataTypeCheck"
    Type="Integer">(Invalid Delivered Days)</asp:CompareValidator>
  <br />
  <br />
  ...
  <div class="button">
    ...
    <asp:Button ID="btnReset"
      runat="server"
      Text="Reset" CommandName="Cancel" /></div>
  <br />
  <br />
</asp:Content>