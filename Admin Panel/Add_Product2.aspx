        ...
        <asp:FormView ID="FormView1" runat="server" DefaultMode="Insert" 
            ...
            <InsertItemTemplate>
                ...
                <asp:Label ID="lbl_proname" runat="server" Style="position: relative" 
                    Text="Product Title :"></asp:Label>
                &nbsp;
                <asp:TextBox ID="txt_proname" runat="server" 
                    Style="position: relative; top: 0px; left: 2px;"></asp:TextBox>
                <br />
                <br />
                ...
                &nbsp;
                <asp:TextBox ID="txt_price" runat="server" Style="position: relative"></asp:TextBox>
                <br />
                <br />
                ...
                &nbsp;&nbsp;<asp:TextBox ID="txt_Qty" runat="server" Style="position: relative"></asp:TextBox>
                <br />
                <br />
                <asp:Label ID="lbl_dlvrddays" runat="server" Style="position: relative" Text="Delivered Days :"></asp:Label>
                &nbsp;&nbsp;<asp:TextBox ID="txt_dlvrddays" runat="server" Style="position: relative"></asp:TextBox>
                <br />
                <br />
                <asp:Image ID="fuplImg1" runat="server" Style="left: 0px; position: relative" Width="30px" />
                &nbsp;<asp:FileUpload ID="fupl_1" runat="server" Style="position: relative; top: 0px;
                    left: 0px;" />
                <br />
                <asp:Image ID="fuplImg2" runat="server" Style="position: relative" Width="30px" />
                <asp:FileUpload ID="fupl_2" runat="server" Style="position: relative" />
                <br />
                <asp:Image ID="fuplImg3" runat="server" Style="position: relative" Width="30px" />
                <asp:FileUpload ID="fupl_3" runat="server" Style="position: relative" />
                <br />
                <asp:Image ID="fuplImg4" runat="server" Style="position: relative; top: 0px; left: 0px;"
                    Width="30px" />
                <asp:FileUpload ID="fupl_4" runat="server" Style="position: relative" />
                <br />
                <asp:Image ID="fuplImg5" runat="server" Style="position: relative" Width="30px" />
                <asp:FileUpload ID="fupl_5" runat="server" Style="position: relative; top: 1px; left: 0px;" />
            </InsertItemTemplate>
        </asp:FormView>
        <br />
    </div>
