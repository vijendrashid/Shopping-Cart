<%@ Page Title="" Language="C#" MasterPageFile="~/Admin Panel/Admin.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="Admin_Panel_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="AdminPanelMaster" runat="Server">
    <div>
        ...
        &nbsp;&nbsp;<asp:TextBox ID="txtSku" runat="server" MaxLength="30"></asp:TextBox>
        <br />
        <br />
        ...
        <br />
        <div>
            <asp:Button ID="btnSubmit" runat="server" Text="Submit" CommandName="Insert" OnClick="Button1_Click" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
