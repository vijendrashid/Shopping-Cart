<%@ Page Title="" Language="C#" MasterPageFile="~/Admin Panel/Admin.master" AutoEventWireup="true"
    CodeFile="Profiles.aspx.cs" Inherits="Admin_Panel_Profiles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="AdminPanelMaster" runat="Server">
    <asp:GridView ID="GridView1" runat="server" CellPadding="4" EnableModelValidation="True"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="DataSize" HeaderText="DataSize" ReadOnly="True" SortExpression="DataSize" />
        </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HomeConnectionString %>"
        SelectCommand="SELECT [UserId], [LastUpdatedDate], [DataSize] FROM [vw_aspnet_Profiles]"
