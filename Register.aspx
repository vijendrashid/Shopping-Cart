...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <div>
            <asp:Label ID="lblMsgSingup" runat="server" Text="New User? Sign Up"></asp:Label>
            <br />
            <asp:Label ID="lblmsg" runat="server" Text=""></asp:Label></div>
        <div>
            <asp:Label ID="lblNewUserName" runat="server" Text="New Username : " AssociatedControlID="txtNewUserName"></asp:Label><asp:TextBox
                ID="txtNewUserName" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="rfvNewUserName" runat="server" ControlToValidate="txtNewUserName"
                Display="Dynamic">(Required)</asp:RequiredFieldValidator>
        </div>
        <div>
            <asp:Label ID="lblNewPassword" runat="server" Text="New Password : " AssociatedControlID="txtEmailID"></asp:Label>
        ...
        <div>
            ...
            <asp:TextBox ID="txtNewPassAgain" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="rfvNewPassAgain" runat="server" ControlToValidate="txtNewPassAgain"
                Display="Dynamic">(Required)</asp:RequiredFieldValidator>
            <asp:CompareValidator ID="comvNewPassAgain" runat="server" ControlToCompare="txtNewPassword"
                ControlToValidate="txtNewPassAgain" Display="Dynamic">(Both password are not same.)</asp:CompareValidator>
        </div>
        <div>
            <asp:Label ID="lblEmailID" runat="server" Text="Email Address : " AssociatedControlID="txtEmailID"></asp:Label><asp:TextBox
